  ...
  return (
    <Page>
      ...
      <p className="pStandard mt-28">
        Por el momento, para lograr estos perfiles, se consumiran APIs de recursos externos como{' '}
      ...
      <p className="pStandard">
        El análisis más puntual es para satisfacer la curiosidad del usuario. Se mostrará con distintos niveles de
      ...
      <p className="pStandard">
        En <b>conclusión</b>, la idea es despertarle inquietud, temor y curiosidad al usuario cuando utiliza la
        app. El objetivo es llevarlo a una mejor concientización del uso de sus datos, brindando información clara
      ...
      <p className="pStandard">
        En un futuro, el producto tendrá una gran parte enfocada en educación y concientización, se ofrecerá al
        usuario otros servicios como advertir si una contraseña fue vulnerada y poder actualizarla fácilmente. A su vez,
        esto brinda una oportunidad de negocio para concientizar a los usuarios sobre buenas prácticas respecto al
      ...
      <p className="pStandard">
        ...
        internet (APIs públicas) y resultará necesario desarrollar nuevas bases de datos propias que se podrán usar para
        mejorar el servicio y brindarse como un servicio en sí (a los Ministerios de Educación y Legislación por
        ejemplo).
      </p>
      <h3 className="mb-4 pl-3 border-l-2 border-primary-300 text-xl font-semibold leading-none tracking-tight">
      ...
      <p className="pStandard">
        El producto permite al usuario hacer un “trade off” a conciencia entre lo que una aplicación le brinda y el
      ...
      <p className="pStandard">
        Al agregarse una nueva app a tu teléfono el usuario será notificado con el grado de
        exposición dependiendo sus preferencias.
      </p>
    </Page>
  );
};
