...
const CardChartSurvey1 = () => {
  ...
  return (
    <Card className="flex flex-col">
      ...
      <CardFooter className="text-sm leading-normal text-muted-foreground">
        Foto del DNI 236 (73.3%), Identificación por cámara 202 (62.7%), Huella dactilar 194 (60.2%), Teléfono 121
        (37.6%), Nombre completo 80 (24.8%), Correo 44 (13.7%), Otros 31 (9.6%)
      </CardFooter>
    </Card>
  );
};
...
const CardChartSurvey2 = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          ¿Qué información te gustaría que estuviera más clara en los términos y condiciones de los sitios web?
        </CardTitle>
      </CardHeader>
      <CardContent className="pb-0">
        <ChartContainer config={chartConfig} className="scale-90">
          <RadarChart data={chartData}>
            <ChartTooltip cursor={false} content={<ChartTooltipContent />} />
            <PolarAngleAxis dataKey="month" />
            <PolarGrid />
      ...
      <CardFooter className="text-sm leading-normal text-muted-foreground">
        Política de privacidad y manejo de datos personales 175 (54.3%), Uso de cookies y tecnologías de seguimiento 106
        (32.9%), Derechos y responsabilidades del usuario 99 (30.7%), Condiciones de uso y restricciones 80 (24.8%),
        Estoy conforme 69 (21.4%), NS/NC 38 (11.8%)
      </CardFooter>
    </Card>
  );
};
    ...
    <Page>
      ...
      <div className="mb-8 p-5 bg-white rounded-2xl shadow">
        ...
        <p className="pStandard">
          ...
          actualizados con las noticias relacionadas con este tema pero al parecer es lo contrario y la edad es un
          factor importante para evaluar la conciencia sobre las consecuencias de los contratos.
        </p>
        <p className="pStandard">
          Algo importante para destacar es que si bien mas del <b>70%</b> reflejó una preocupación importante por su
          privacidad en linea, solo el <b>3.7%</b> se toma el tiempo de leer los Términos y Condiciones. Esto es una{' '}
        ...
        <p className="pStandard">
          Otro dato para destacar fueron los <b>175</b> (54.3%) encuestados que demostrarón un interés en que esté más
          clara la política de privacidad y manejos de datos personales.
        </p>
        <p className="pStandard">
          Una peculiaridad es que un <b>12.4%</b> acepta por el hecho de confiar en la empresa que se esta registrando.
          Es una decisión muy cuestionable como se vió en el desarollo del problema lo que pasó con Disney [8] y Uber
          [11].
        </p>
        <p className="pStandard">
